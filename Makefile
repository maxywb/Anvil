...
VPATH = derived 
all: main/main.cpp $(parserOut) $(visitorOut) $(symbolTableOut) $(bisonOut) setup
	@echo make all
...
$(symbolTableOut): $(symbolTableIn) | setup
